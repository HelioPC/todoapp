...
import { UserStorageName } from '../../assets/dummy'
...
const SidebarHeader = ({ open, name, onClick }: SidebarHeaderProps) => {
    return (
...
const Sidebar = () => {
    ...
    var menu = [
        { title: `Eu ${user.name}`, icon: <MdPerson size={iconSize - 3} />, link: `/app` },
        { title: 'Voos', icon: <MdFlight size={iconSize - 3} />, link: `/app` },
    ]
        ...
        <>
                    ...
                    {menu.map((item, index) => (
                        <li key={index}>
                            <NavLink
                                to={item.link}
                                className='
                                    flex items-center gap-x-4 px-2 py-3 text-sm
            ...
            >
                <ul
                    ...
                    >
                        <li className='my-5'>
                            <SidebarHeader open={true} name={user.name} onClick={() => navigate('/')} />
                        </li>
